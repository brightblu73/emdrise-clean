        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-slate-700 leading-relaxed">
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">1. Introduction & Acceptance</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">2. Eligibility & Age Restrictions</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">3. Description of the Services</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">4. Medical Disclaimer</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">5. Account Registration & Subscription</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">6. Limited License & Acceptable Use</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">7. Ownership & Intellectual Property</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">8. AI Features & Future Development</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">9. Third‑Party Services & External Links</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">10. Disclaimers & Limitation of Liability</h2>
                <p className="mb-4">
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">11. Indemnification</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">12. Governing Law & Dispute Resolution</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">13. Changes to Terms</h2>
                <p>
              ...
              <section>
                <h2 className="text-2xl font-bold text-[#1E90FF] mb-4">14. Contact Information</h2>
                <p>
